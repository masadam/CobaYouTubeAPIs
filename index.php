...
$YT_API_Identity_result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCdsE9y553KP7Z7MDXzM1sRg&key=AIzaSyCH1fWHEJwA4gGBZKwckOMHtXhOvMBzZto');
$YT_API_Videos_result = get_CURL('https://www.googleapis.com/youtube/v3/search?key=AIzaSyCH1fWHEJwA4gGBZKwckOMHtXhOvMBzZto&channelId=UCdsE9y553KP7Z7MDXzM1sRg&maxResults=1&order=date&part=snippet');
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="g-ytsubscribe" data-channelid="UCdsE9y553KP7Z7MDXzM1sRg" data-layout="default" data-count="default"></div> <!--Tombol SUbscription-->
                </p>
              </div>
            </div>
          ...
          <div class="col-md-5">
            ...
            <div class="row">
              <div class="col">
                <div class="overflow-hidden" style="width:100px; height:100px; float:left; overflow: hidden;">
                  <img src="img/thumbs/1.png" alt="" width="100px">
                </div>
                <div class="overflow-hidden" style="width:100px; height:100px; float:left; overflow: hidden;">
                  <img src="img/thumbs/2.png" alt="" width="100px">
                </div>
                <div class="overflow-hidden" style="width:100px; height:100px; float:left; overflow: hidden;">
                  <img src="img/thumbs/3.png" alt="" width="100px">
                </div>
              </div>
            </div>
          </div>
